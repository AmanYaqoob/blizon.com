            ...
            {items.map((item, index) => (
                <div
                    ...
                    className={cn(
                        ...
                        {
                            "shadow-[0_8px_32px_rgba(255,255,255,0.06)] -translate-y-1":
                ...
                >
                    ...
                    <div className="relative flex flex-col space-y-3">
                        <div className="flex items-center justify-between">
                            <div className="w-12 h-12 rounded-xl flex items-center justify-center bg-white/10 group-hover:bg-white/20 transition-all duration-300">
                                {item.icon}
                            </div>
                            <span
                                className={cn(
